...
public class MovieRepositoryTest {
    ...
    public void findByName() {
        movieRepository.save(movie);
        Assert.assertEquals(movieRepository.findAll(),movieRepository.findMovieByMovieName("Matrix"));
    }
    @Test
    public void findByNameFailure() {
        movieRepository.save(movie);
        Assert.assertNotEquals(movieRepository.findAll(),movieRepository.findMovieByMovieName("Lion"));
    }
